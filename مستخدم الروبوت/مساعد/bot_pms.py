    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا اخوي  {mention} **\
                        ...
                        \n\n**⌔︙ البوت خاص بسورس :** [TELETHON FOR ARABS](https://t.me/MedThon)"
        buttons = [
            (
...
@MedThon.bot_cmd(incoming=True, func=lambda e: e.is_private)
...
@MedThon.tgbot.on(CallbackQuery(data=re.compile(b"bot_pm_ban_([0-9]+)")))
@check_owner
...
@MedThon.tgbot.on(CallbackQuery(data=re.compile(b"toggle_bot-antiflood_off$")))
@check_owner
...
@MedThon.bot_cmd(incoming=True, func=lambda e: e.is_private)
@MedThon.bot_cmd(edited=True, func=lambda e: e.is_private)
