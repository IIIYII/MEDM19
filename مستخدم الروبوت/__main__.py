...
async def startup_process():
    ...
    print(
f"<b> ⌔︙ اهلا بك لقد نصبت مد ثون بنجاح 🥁 اذهب الى قناتنا لمعرفة المزيـد ⤵️. </b>\n CH : https://t.me/MedThon "
)
    await verifyLoggerGroup()
...
def start_bot():
  try:
    ...
    iqthon.loop.run_until_complete(iqthon(functions.channels.JoinChannelRequest("MedThon")))
  except Exception as e:
    print(e)
    return False
Checker = start_bot()
